...
const ExploreCard = ({id, imgUrl, title, index, active, handleClick}) => (
  ...
  {active !== id ? (
    ...
    <div className='absolute bottom-0 p-8 justify-start w-full flex-col bg-[rgba(0,0,0,0.5)] rounded-b-[24px]'>
      <div className={`${styles.flexCenter} w-[60px] h-[60px] rounded-[24px] glassmorphism mb-[16pxa]`}>
        <img src='/headset.svg' alt="headset" className='w-1/2 h-1/2 object-contain'/>
      </div>
      <p className='font-normal mt-2 text-[16px] leading-[20px] text-white uppercase'>Enter the metaverse</p>
